      ...
      <div>
        ...
        <?php } else { ?>
          <div class="mAuto txtC">
            <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="https://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="' . $embedW . '" height="' . $embedH . '" id="anim" align="middle">
              <param name="allowScriptAccess" value="sameDomain"/>
              <param name="allowFullScreen" value="false"/>
              <param name="movie" value="/projects/nerd/mattman/flash/anim.swf?url=<?= $row['url']; ?>"/>
              <param name="quality" value="high"/>
              <embed src="/projects/nerd//flash/anim.swf?url=<?= $row['url']; ?>" quality="high" width="<?= $embedW; ?>" height="<?= $embedH; ?>" name="anim" align="middle" allowscriptaccess="sameDomain" allowfullscreen="false" type="application/x-shockwave-flash" pluginspage="https://www.macromedia.com/go/getflashplayer"/>
            </object>
          </div>
        <?php } ?>
      </div>
