...
<div class="p10">
	<div class="mAuto bdrLtBrown bdrRound p10 w800">
		...
		$num = (int)$rowCount;
		$next = ($num+1);
		$url = 'http://www.kittenberg.com/projects/nerd/monsters/' . $_POST['type'] . '/' . $_POST['filename'] . '.png';
		$gif = 'http://www.kittenberg.com/projects/nerd/gif/monsters/' . $_POST['type'] . '/' . $_POST['filename'] . '.gif';
